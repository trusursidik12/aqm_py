...
try:
    if sys.platform.startswith('win'):
        ...
        command = "python3 ~/aqm_py/labjack_reader.py"
...
try:
    ...
    if(rec[0] != None and rec[0] != ""):
        ...
        if sys.platform.startswith('win'):
            ...
            command = "python3 ~/aqm_py/pm_reader.py 10"
...
try:    
    ...
    if(rec[0] != None and rec[0] != ""):
        ...
        if sys.platform.startswith('win'):
            ...
            command = "python3 ~/aqm_py/pm_reader.py 25"
...
try:    
    ...
    if(rec[0] != None and rec[0] != ""):
        ...
        if sys.platform.startswith('win'):
            ...
            command = "python3 ~/aqm_py/hc_reader.py"
...
try:        
    ...
    if(rec[0] != None and rec[0] != ""):
        ...
        if sys.platform.startswith('win'):
            ...
            command = "python3 ~/aqm_py/ws_davis_reader.py"
...
try:        
    ...
    if(rec[0] != None and rec[0] != ""):
        ...
        if sys.platform.startswith('win'):
            ...
            command = "python3 ~/aqm_py/ws_airmar_reader.py"
